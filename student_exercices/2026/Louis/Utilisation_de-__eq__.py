class ColectionDeGamers:
    ...
    def __eq__(self, autre):
        ...
        return self.colect_de_jeux_video == autre.colect_de_jeux_video or self.nom == autre.nom
...
if __name__ == '__main__':
    ...
    colection_de_gamer_c = ColectionDeGamers('Ben', ("Celeste", "New super mario Bros.", "Mario kart wii"), 16)
